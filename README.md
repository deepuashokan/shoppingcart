...
A Cart object represents a shopping cart. The Cart class provides various methods to manipulate on items and quantities on the shopping cart like adding items, update quantities, remove items,...For an example, see the example folder. 
